...
events go through bgmet counters instead.

DESIGN NOTES:
  - Logger lives in internal/bglog to avoid import cycles between the root
    package, internal/rest and internal/ws. The root bitget package
    re-exports the interface as bitget.Logger via a type alias (see
